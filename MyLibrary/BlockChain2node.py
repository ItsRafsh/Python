...
# kenapa ada 2 karena file ini bisa menggunakan 2 node lebih untuk system blockchain nya
...
# PENAMBAHAN LEBIH DARI 1 NODES KOMPUTER MINING
    ...
    def valid_chain(self, chain):
        ...
        while current_index < len(chain):
            ...
            if not self.valid_proof(
                current_index, block['hash_of_previous_block'],
                block['transactions'],
                block['nonce']):
                return False
...
def add_nodes():
    ...
    response = {'message':'Node baru telah ditambahkan',
...
def sync():
    ...
    if updated:
        response = {'message':'blockchain telah di update dengan data terbaru',
                    'blockchain':blockchain.chain}
    else:
        response = {'message':'blockchain sudah menggunakan data paling baru',
                    'blockchain':blockchain.chain}
    return jsonify(response), 200
